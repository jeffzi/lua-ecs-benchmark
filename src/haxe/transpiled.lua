...
HaxeBenchmark = _hx_e()
CreateEmptyEntity = _hx_e()
CreateEntities = _hx_e()
...
Array.prototype.concat = function(self,a) 
  ...
  local _g1 = 0;
  while (_g1 < self.length) do _hx_do_first_1 = false;
  ...
  local _g1 = 0;
  while (_g1 < a.length) do _hx_do_first_1 = false;
...
Array.prototype.join = function(self,sep) 
  local tbl = ({});
  local _g_current = 0;
  while (_g_current < self.length) do _hx_do_first_1 = false;
...
Array.prototype.unshift = function(self,x) 
  ...
  local _g = 0;
  while (_g < len) do _hx_do_first_1 = false;
...
Array.prototype.indexOf = function(self,x,fromIndex) 
  ...
  local _g = fromIndex;
  while (_g < _end) do _hx_do_first_1 = false;
...
__echoes_ComponentStorage.prototype.get_name = function(self) 
  do return Std.string(Std.string("ComponentStorage<") .. Std.string(self.componentType)) .. Std.string(">") end
end
__echoes_ComponentStorage.prototype.get_relatedViews = function(self) 
  do return self._relatedViews end
end
__echoes_ComponentStorage.prototype.add = function(self,entity,component) 
  ...
  if (self.ongoingRemovals:contains(entity)) then 
    _G.error(__haxe_Exception.thrown(Std.string(Std.string(Std.string(Std.string("Attempted to add ") .. Std.string(self.componentType)) .. Std.string(" to entity ")) .. Std.string(entity)) .. Std.string(" during a @:remove listener for that component.")),0);
  end;
...
__echoes_ComponentStorage.prototype.exists = function(self,entity) 
  do return self.storage[entity] ~= nil end
end
__echoes_ComponentStorage.prototype.get = function(self,entity) 
  do return self.storage[entity] end
end
...
__echoes_System.super = function(self,priority) 
  ...
  self.priority = (function() 
    ...
    _hx_1 = priority; else 
    _hx_1 = self:__getDefaultPriority__(); end
    return _hx_1
  end )();
...
__echoes_System.prototype.__addListenersWithPriority__ = function(self,priority,runUpdateListeners) 
...
__echoes_System.prototype.getStatistics = function(self) 
  do return _hx_o({__fields__={name=true},name=Std.string(self)}) end
end
...
__echoes_SystemList.super = function(self,name,clock,priority) 
  ...
  self.clock = (function() 
    ...
    if (clock ~= nil) then 
    _hx_1 = clock; else 
    _hx_1 = __echoes_utils_Clock.new(); end
    return _hx_1
  end )();
end
...
__echoes_SystemList.prototype.get_length = function(self) 
  do return self.systems.length end
end
__echoes_SystemList.prototype.get_paused = function(self) 
  do return self.clock.paused end
end
__echoes_SystemList.prototype.set_paused = function(self,value) 
  self.clock.paused = value do return self.clock.paused end
end
...
__echoes_SystemList.prototype.__recalculateOrder__ = function(self,system) 
  if (self.systems:remove(system)) then 
    local index = Lambda.findIndex(self.systems, function(existingSystem) 
      do return existingSystem.priority < system.priority end;
    end);
    if (index >= 0) then 
...
__echoes_SystemList.prototype.__update__ = function(self,dt) 
  ...
  local _g = self.clock;
  while (_g.time >= _g.minTickLength) do _hx_do_first_1 = false;
...
__echoes_SystemList.prototype.exists = function(self,system) 
  ...
  while ((parent ~= nil) and (parent ~= self)) do _hx_do_first_1 = false;
    
    parent = parent.parent;
  end;
  do return parent == self end
end
...
__echoes_SystemList.prototype.iterator = function(self) 
  do return __haxe_iterators_ArrayIterator.new(self.systems) end
end
__echoes_SystemList.prototype.keyValueIterator = function(self) 
  do return __haxe_iterators_ArrayKeyValueIterator.new(self.systems) end
end
...
__echoes_Echoes.get_activeEntities = function() 
  do return __echoes_Echoes._activeEntities end;
end
__echoes_Echoes.get_activeViews = function() 
  do return __echoes_Echoes._activeViews end;
end
__echoes_Echoes.get_clock = function() 
  do return __echoes_Echoes.activeSystems.clock end;
end
...
__echoes_Echoes.getStatistics = function() 
  ...
  while (system_current < _this.length) do _hx_do_first_1 = false;
  ...
  while (_g2 < _g3.length) do _hx_do_first_1 = false;
    
    local view = _g3[_g2];
    _g2 = _g2 + 1;
    _g1:push(_hx_o({__fields__={name=true,entities=true},name=Std.string(view),entities=view._entities.length}));
  end;
  do return _hx_o({__fields__={cachedEntities=true,entities=true,systems=true,views=true},cachedEntities=tmp,entities=tmp1,systems=_g,views=_g1}) end;
end
...
ComponentStorage_EchoesBenchmarkOptional.prototype.__class__ =  ComponentStorage_EchoesBenchmarkOptional
ComponentStorage_EchoesBenchmarkOptional.__super__ = __echoes_ComponentStorage
setmetatable(ComponentStorage_EchoesBenchmarkOptional.prototype,{__index=__echoes_ComponentStorage.prototype})
...
ComponentStorage_EchoesBenchmarkPadding1.prototype.__class__ =  ComponentStorage_EchoesBenchmarkPadding1
ComponentStorage_EchoesBenchmarkPadding1.__super__ = __echoes_ComponentStorage
setmetatable(ComponentStorage_EchoesBenchmarkPadding1.prototype,{__index=__echoes_ComponentStorage.prototype})
...
ComponentStorage_EchoesBenchmarkPadding2.prototype.__class__ =  ComponentStorage_EchoesBenchmarkPadding2
ComponentStorage_EchoesBenchmarkPadding2.__super__ = __echoes_ComponentStorage
setmetatable(ComponentStorage_EchoesBenchmarkPadding2.prototype,{__index=__echoes_ComponentStorage.prototype})
...
ComponentStorage_EchoesBenchmarkPadding3.prototype.__class__ =  ComponentStorage_EchoesBenchmarkPadding3
ComponentStorage_EchoesBenchmarkPadding3.__super__ = __echoes_ComponentStorage
setmetatable(ComponentStorage_EchoesBenchmarkPadding3.prototype,{__index=__echoes_ComponentStorage.prototype})
...
ComponentStorage_EchoesBenchmarkPosition.prototype.__class__ =  ComponentStorage_EchoesBenchmarkPosition
ComponentStorage_EchoesBenchmarkPosition.__super__ = __echoes_ComponentStorage
setmetatable(ComponentStorage_EchoesBenchmarkPosition.prototype,{__index=__echoes_ComponentStorage.prototype})
...
ComponentStorage_EchoesBenchmarkVelocity.prototype.__class__ =  ComponentStorage_EchoesBenchmarkVelocity
ComponentStorage_EchoesBenchmarkVelocity.__super__ = __echoes_ComponentStorage
setmetatable(ComponentStorage_EchoesBenchmarkVelocity.prototype,{__index=__echoes_ComponentStorage.prototype})
...
MovementSystem.prototype.__update__ = function(self,dt) 
  ...
  while (_g < _g1.length) do _hx_do_first_1 = false;
    ...
    local entity = _g1[_g];
    _g = _g + 1;
    callback(entity, ComponentStorage_EchoesBenchmarkPosition.instance.storage[entity], ComponentStorage_EchoesBenchmarkVelocity.instance.storage[entity]);
  end;
end
...
HaxeBenchmark.prototype.teardown = function(self) 
  __echoes_Echoes.reset();
end

HaxeBenchmark.prototype.__class__ =  HaxeBenchmark

CreateEmptyEntity.new = function(n_entities) 
  local self = _hx_new(CreateEmptyEntity.prototype)
  CreateEmptyEntity.super(self,n_entities)
  return self
end
CreateEmptyEntity.super = function(self,n_entities) 
  HaxeBenchmark.super(self,n_entities);
end
CreateEmptyEntity.__name__ = "CreateEmptyEntity"
CreateEmptyEntity.prototype = _hx_e();
CreateEmptyEntity.prototype.run = function(self) 
  local _g = 0;
...
CreateEmptyEntity.prototype.__class__ =  CreateEmptyEntity
CreateEmptyEntity.__super__ = HaxeBenchmark
setmetatable(CreateEmptyEntity.prototype,{__index=HaxeBenchmark.prototype})

CreateEntities.new = function(n_entities) 
  local self = _hx_new(CreateEntities.prototype)
  CreateEntities.super(self,n_entities)
  return self
end
CreateEntities.super = function(self,n_entities) 
  HaxeBenchmark.super(self,n_entities);
end
CreateEntities.__name__ = "CreateEntities"
CreateEntities.prototype = _hx_e();
CreateEntities.prototype.run = function(self) 
  local _g = 0;
  local _g1 = self.n_entities;
  while (_g < _g1) do _hx_do_first_1 = false;
...
CreateEntities.prototype.__class__ =  CreateEntities
CreateEntities.__super__ = HaxeBenchmark
setmetatable(CreateEntities.prototype,{__index=HaxeBenchmark.prototype})
...
SystemUpdate.super = function(self,n_entities) 
  ...
  while (_g < _g1) do _hx_do_first_1 = false;
    ...
    elseif (padding) == 3 then 
      ComponentStorage_EchoesBenchmarkPadding3.instance:add(__entity__, true);else end;
    local shuffle = _G.math.fmod((i + 1), 4);
    if (shuffle) == 0 then 
      ComponentStorage_EchoesBenchmarkPosition.instance:remove(__entity__);
    elseif (shuffle) == 1 then 
      ComponentStorage_EchoesBenchmarkVelocity.instance:remove(__entity__);else end;
  end;
...
__echoes_ViewBase.prototype.get_entities = function(self) 
  do return self._entities end
end
__echoes_ViewBase.prototype.get_active = function(self) 
  do return self.activations > 0 end
end
...
__echoes_ViewBase.prototype.dispatchAddedCallback = function(self,entity) 
end
__echoes_ViewBase.prototype.dispatchRemovedCallback = function(self,entity,removedComponentStorage,removedComponent) 
end
__echoes_ViewBase.prototype.isMatched = function(self,entity) 
  do return false end
end
__echoes_ViewBase.prototype.remove = function(self,entity,removedComponentStorage,removedComponent) 
...
ViewOf_Position_Velocity_92d16.prototype.dispatchRemovedCallback = function(self,entity,removedComponentStorage,removedComponent) 
  local exception = nil;
  local _g = 0;
  ...
  while (_g < _g1.length) do _hx_do_first_1 = false;
    ...
    local _hx_status, _hx_result = pcall(function() 
        ...
        callback(entity, (function() 
          local _hx_1
          if (ComponentStorage_EchoesBenchmarkPosition.instance == removedComponentStorage) then 
          _hx_1 = removedComponent; else 
          _hx_1 = ComponentStorage_EchoesBenchmarkPosition.instance.storage[entity]; end
          return _hx_1
        end )(), (function() 
          local _hx_2
          if (ComponentStorage_EchoesBenchmarkVelocity.instance == removedComponentStorage) then 
          _hx_2 = removedComponent; else 
          _hx_2 = ComponentStorage_EchoesBenchmarkVelocity.instance.storage[entity]; end
          return _hx_2
        end )());
      return _hx_pcall_default
    end)
...
ViewOf_Position_Velocity_92d16.prototype.isMatched = function(self,entity) 
  if (ComponentStorage_EchoesBenchmarkVelocity.instance.storage[entity] ~= nil) then 
    do return ComponentStorage_EchoesBenchmarkPosition.instance.storage[entity] ~= nil end;
  else
    do return false end;
  end;
end
ViewOf_Position_Velocity_92d16.prototype.toString = function(self) 
  do return "EchoesBenchmark.Position, EchoesBenchmark.Velocity" end
end
...
__echoes__ComponentStorage_DynamicComponentStorage_Impl_.__name__ = "echoes._ComponentStorage.DynamicComponentStorage_Impl_"
__echoes__ComponentStorage_DynamicComponentStorage_Impl_.fromComponentStorage = function(componentStorage) 
  do return componentStorage end;
end

__echoes__ComponentStorage_EntityComponents_Impl_.new = {}
__echoes__ComponentStorage_EntityComponents_Impl_.__name__ = "echoes._ComponentStorage.EntityComponents_Impl_"
...
__echoes__ComponentStorage_EntityComponents_Impl_.forEntity = function(entity) 
  if (__echoes__ComponentStorage_EntityComponents_Impl_.components[entity] == nil) then 
    __echoes__ComponentStorage_EntityComponents_Impl_.components[entity] = Array.new() do return __echoes__ComponentStorage_EntityComponents_Impl_.components[entity] end;
  else
    do return __echoes__ComponentStorage_EntityComponents_Impl_.components[entity] end;
  end;
end
...
__echoes__Entity_Entity_Impl_.get_active = function(this1) 
  do return __echoes_Echoes.activeEntityIndices[this1] ~= nil end;
end
__echoes__Entity_Entity_Impl_.get_destroyed = function(this1) 
  if (__echoes_Echoes.activeEntityIndices[this1] == nil) then 
    do return __echoes__Entity_Entity_Impl_.idPool:contains(this1) end;
  else
    do return false end;
  end;
end
...
__echoes__Entity_Entity_Impl_.activate = function(this1) 
  if (__echoes_Echoes.activeEntityIndices[this1] == nil) then 
    ...
    local _g_array = (function() 
      ...
      if (__echoes__ComponentStorage_EntityComponents_Impl_.components[entity] == nil) then 
      __echoes__ComponentStorage_EntityComponents_Impl_.components[entity] = Array.new()
      _hx_1 = __echoes__ComponentStorage_EntityComponents_Impl_.components[entity]; else 
      _hx_1 = __echoes__ComponentStorage_EntityComponents_Impl_.components[entity]; end
      return _hx_1
    end )();
    while (_g_current < _g_array.length) do _hx_do_first_1 = false;
...
__echoes__Entity_Entity_Impl_.destroy = function(this1) 
  if (not ((__echoes_Echoes.activeEntityIndices[this1] == nil) and __echoes__Entity_Entity_Impl_.idPool:contains(this1))) then 
    local entity = this1;
    local entityComponents = __echoes__ComponentStorage_EntityComponents_Impl_.components[entity];
    if (entityComponents ~= nil) then 
      __echoes__ComponentStorage_EntityComponents_Impl_.components[entity] = Array.new();
...
__echoes__System_ChildSystem.prototype.toString = function(self) 
  do return Std.string(self.parentSystem:toString()) .. Std.string((Std.string(":") .. Std.string(self.priority))) end
end
...
__echoes_utils__ComponentTypes_ComponentTypes_Impl_.__name__ = "echoes.utils._ComponentTypes.ComponentTypes_Impl_"
__echoes_utils__ComponentTypes_ComponentTypes_Impl_.addComponentStorage = function(this1,storage) 
  if (not this1:contains(storage)) then 
    this1:push(storage);
  end;
end
__echoes_utils__ComponentTypes_ComponentTypes_Impl_.containsComponentStorage = function(this1,storage) 
  do return this1:contains(storage) end;
end
...
__echoes_utils__ComponentTypes_ComponentTypes_Impl_.removeComponentStorage = function(this1,storage) 
  local index = this1:lastIndexOf(storage);
  if (index >= 0) then 
    this1[index] = this1[this1.length - 1];
    this1:pop();
...
__echoes_utils__ReadOnlyData_ReadOnlyList_Impl_.__name__ = "echoes.utils._ReadOnlyData.ReadOnlyList_Impl_"
__echoes_utils__ReadOnlyData_ReadOnlyList_Impl_.has = function(this1,item) 
  do return Lambda.has(this1, item) end;
end
...
__echoes_utils__Signal_Signal_Impl_.indexOf = function(this1,listener) 
  local _g_current = 0;
  while (_g_current < this1.length) do _hx_do_first_1 = false;
    
    local _g_value = this1[_g_current];
    _g_current = _g_current + 1;
    if (Reflect.compareMethods(_g_value, listener)) then 
      do return _g_current - 1 end;
    end;
  end;
  do return -1 end;
end
...
__haxe_MainLoop.sortEvents = function() 
  ...
  while (true) do _hx_do_first_1 = false;
    ...
    tail = nil;
    nmerges = 0;
    while (p ~= nil) do _hx_do_first_2 = false;
      ...
      qsize = insize;
      while ((psize > 0) or ((qsize > 0) and (q ~= nil))) do _hx_do_first_3 = false;
...
__haxe_NativeStackTrace.callStack = function() 
  ...
  if (_g == nil) then 
    ...
    do return String.prototype.split(_g, "\n"):slice(3) end;
  end;
end
...
local _hx_static_init = function()
  ...
  String.__name__ = "String";
  Array.__name__ = "Array";__echoes_Echoes.componentStorage = _hx_tab_array({}, 0);
  ...
  ComponentStorage_EchoesBenchmarkOptional.instance = ComponentStorage_EchoesBenchmarkOptional.new();
  
  ComponentStorage_EchoesBenchmarkPadding1.instance = ComponentStorage_EchoesBenchmarkPadding1.new();
  
  ComponentStorage_EchoesBenchmarkPadding2.instance = ComponentStorage_EchoesBenchmarkPadding2.new();
  
  ComponentStorage_EchoesBenchmarkPadding3.instance = ComponentStorage_EchoesBenchmarkPadding3.new();
  
  ComponentStorage_EchoesBenchmarkPosition.instance = ComponentStorage_EchoesBenchmarkPosition.new();
  
  ComponentStorage_EchoesBenchmarkVelocity.instance = ComponentStorage_EchoesBenchmarkVelocity.new();
