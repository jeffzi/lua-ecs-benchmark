...
__echoes_ComponentStorage.new = function(name)
   local self = _hx_new(__echoes_ComponentStorage.prototype)
   __echoes_ComponentStorage.super(self, name)
   return self
end
__echoes_ComponentStorage.super = function(self, name)
   self.relatedViews = _hx_tab_array({}, 0)
   self.storage = __haxe_ds_IntMap.new()
   self.name = name
...
__echoes_ComponentStorage.prototype.add = function(self, entity, component)
   ...
   local ret = self.storage.h[entity]
   if ret == __haxe_ds_IntMap.tnull then
      ret = nil
   end
   if ret == component then
      do
         return
      end
   end
   local _this = self.storage
   local key = entity
   if component == nil then
   ...
   if __echoes__Entity_Entity_Impl_.statuses[entity] then
      local _g = 0
      local _g1 = self.relatedViews
      while _g < _g1.length do
         ...
         if self.storage.h[entity] == nil then
            do
               return
            end
         end
...
__echoes_ComponentStorage.prototype.exists = function(self, entity)
   do
      return self.storage.h[entity] ~= nil
   end
end
...
__echoes_ComponentStorage.prototype.remove = function(self, entity)
   ...
   local removedComponent = ret
   if self.storage:remove(entity) and __echoes__Entity_Entity_Impl_.statuses[entity] then
      local _g = 0
      local _g1 = self.relatedViews
      while _g < _g1.length do
         _hx_do_first_1 = false
         ...
         local view = _g1[_g]
         _g = _g + 1
         view:removeIfExists(entity, self, removedComponent)
         if self.storage.h[entity] ~= nil then
            do
               return
            end
...
__echoes_Echoes.reset = function()
   local _g = 0
   local _g1 = __echoes__Entity_Entity_Impl_.statuses.length
   while _g < _g1 do
      _hx_do_first_1 = false

      _g = _g + 1
      __echoes__Entity_Entity_Impl_.statuses[_g - 1] = false
   end
   __echoes_Echoes._activeEntities:clear()
   ...
   __echoes__Entity_Entity_Impl_.statuses:resize(0)
   __echoes__Entity_Entity_Impl_.nextId = 0
   __echoes_Echoes.init(0)
end
__echoes_Echoes.addSystem = function(system)
   __echoes_Echoes.activeSystems:add(system)
end
__echoes_Echoes.removeSystem = function(system)
   __echoes_Echoes.activeSystems:remove(system)
end
__echoes_Echoes.hasSystem = function(system)
   do
      return system.parent == __echoes_Echoes.activeSystems
   end
end
...
MovementSystem.prototype.__deactivate__ = function(self)
   if self.active then
      ViewOf_Position_Velocity_92d16.instance:deactivate()
      __echoes_System.prototype.__deactivate__(self)
   end
end
MovementSystem.prototype.__update__ = function(self, dt)
   ...
   local _g_head = ViewOf_Position_Velocity_92d16.instance._entities.h
   while _g_head ~= nil do
      _hx_do_first_1 = false

      local val = _g_head.item
      _g_head = _g_head.next
      local ret = ComponentStorage_EchoesBenchmarkPosition.instance.storage.h[val]
      if ret == __haxe_ds_IntMap.tnull then
         ret = nil
      end
      local ret1 = ComponentStorage_EchoesBenchmarkVelocity.instance.storage.h[val]
      if ret1 == __haxe_ds_IntMap.tnull then
         ret1 = nil
      end
      callback(val, ret, ret1)
   end
end
...
AddEmptyEntity.prototype.run = function(self)
   ...
   while _g < _g1 do
      ...
      __echoes__Entity_Entity_Impl_.statuses[this1] = true
      __echoes_Echoes._activeEntities:add(this1)
   end
end
...
__echoes_ViewBase.super = function(self)
   self.activations = 0
   self._entities = __haxe_ds_List.new()
end
...
__echoes_ViewBase.prototype.activate = function(self)
   ...
   if self.activations == 1 then
      ...
      local _g_head = __echoes_Echoes._activeEntities.h
      while _g_head ~= nil do
         _hx_do_first_1 = false

         local val = _g_head.item
         _g_head = _g_head.next
         self:addIfMatched(val)
      end
   end
end
__echoes_ViewBase.prototype.addIfMatched = function(self, entity)
   if not Lambda.has(self._entities, entity) then
...
__echoes_ViewBase.prototype.removeIfExists = function(
   self,
   entity,
   removedComponentStorage,
   removedComponent
)
   if self._entities:remove(entity) then
...
__echoes_ViewBase.prototype.reset = function(self)
   ...
   while not self._entities:isEmpty() do
      _hx_do_first_1 = false

      self:removeIfExists(self._entities:first())
   end
end
...
ViewOf_Position_Velocity_92d16.prototype.activate = function(self)
   ...
   if self.activations == 1 then
      ComponentStorage_EchoesBenchmarkPosition.instance.relatedViews:push(self)
      ComponentStorage_EchoesBenchmarkVelocity.instance.relatedViews:push(self)
   end
end
ViewOf_Position_Velocity_92d16.prototype.dispatchAddedCallback = function(self, entity)
   ...
   while _g < _g1.length do
      ...
      _g = _g + 1
      local ret = ComponentStorage_EchoesBenchmarkPosition.instance.storage.h[entity]
      if ret == __haxe_ds_IntMap.tnull then
         ret = nil
      end
      local ret1 = ComponentStorage_EchoesBenchmarkVelocity.instance.storage.h[entity]
      if ret1 == __haxe_ds_IntMap.tnull then
         ret1 = nil
      end
      callback(entity, ret, ret1)
      if not Lambda.has(self._entities, entity) then
         break
      end
   end
...
ViewOf_Position_Velocity_92d16.prototype.dispatchRemovedCallback = function(
   ...
   while _g < _g1.length do
      ...
      if ComponentStorage_EchoesBenchmarkVelocity.instance == removedComponentStorage then
         tmp1 = removedComponent
      else
         local ret = ComponentStorage_EchoesBenchmarkVelocity.instance.storage.h[entity]
         if ret == __haxe_ds_IntMap.tnull then
            ret = nil
         end
         tmp1 = ret
      end
      callback(entity, tmp, tmp1)
      if Lambda.has(self._entities, entity) then
         break
      end
   end
end
ViewOf_Position_Velocity_92d16.prototype.reset = function(self)
   ...
   ComponentStorage_EchoesBenchmarkPosition.instance.relatedViews:remove(self)
   ComponentStorage_EchoesBenchmarkVelocity.instance.relatedViews:remove(self)
end
ViewOf_Position_Velocity_92d16.prototype.iter = function(self, callback)
   local _g_head = self._entities.h
   while _g_head ~= nil do
      _hx_do_first_1 = false
...
ViewOf_Position_Velocity_92d16.prototype.isMatched = function(self, entity)
   if ComponentStorage_EchoesBenchmarkVelocity.instance.storage.h[entity] ~= nil then
      do
         return ComponentStorage_EchoesBenchmarkPosition.instance.storage.h[entity] ~= nil
      end
   else
      do
         return false
...
__echoes__Entity_Entity_Impl_.get_active = function(this1)
   do
      return __echoes__Entity_Entity_Impl_.statuses[this1]
   end
end
__echoes__Entity_Entity_Impl_.get_destroyed = function(this1)
   if not __echoes__Entity_Entity_Impl_.statuses[this1] then
      do
...
__echoes__Entity_Entity_Impl_._new = function(active)
   ...
   __echoes__Entity_Entity_Impl_.statuses[this1] = active
   if active then
      __echoes_Echoes._activeEntities:add(this1)
   end
   do
...
__echoes__Entity_Entity_Impl_.activate = function(this1)
   if not __echoes__Entity_Entity_Impl_.statuses[this1] then
      ...
      __echoes_Echoes._activeEntities:add(this1)
      local _g = 0
      local _g1 = __echoes_Echoes._activeViews
      while _g < _g1.length do
         _hx_do_first_1 = false

         local view = _g1[_g]
         _g = _g + 1
         view:addIfMatched(this1)
      end
   end
end
__echoes__Entity_Entity_Impl_.deactivate = function(this1)
   if __echoes__Entity_Entity_Impl_.statuses[this1] then
      __echoes_Echoes._activeEntities:remove(this1)
      __echoes__Entity_Entity_Impl_.statuses[this1] = false
      local _g = 0
      local _g1 = __echoes_Echoes._activeViews
      while _g < _g1.length do
         _hx_do_first_1 = false
...
__echoes__Entity_Entity_Impl_.getComponents = function(this1)
   ...
   while _g < _g1.length do
      ...
      local storage = _g1[_g]
      _g = _g + 1
      if storage.storage.h[this1] ~= nil then
         local k = storage.name
         local ret = storage.storage.h[this1]
         if ret == __haxe_ds_IntMap.tnull then
            ret = nil
         end
         local v = ret
         if v == nil then
            components.h[k] = __haxe_ds_StringMap.tnull
         else
            components.h[k] = v
         end
      end
...
local _hx_static_init = function()
   ...
   __echoes_Echoes._activeEntities = __haxe_ds_List.new()
   ...
   __echoes__Entity_Entity_Impl_.statuses = _hx_tab_array({}, 0)
